...
class BscScan:
    ...
    def __new__(cls, api_key: str, prefix: str, asynchronous=True, debug=False) -> BaseClient:
        """Create a new client.
        ...
        """
        if asynchronous:
            return AsyncClient(api_key=api_key, prefix=prefix, debug=debug)
        return SyncClient(api_key=api_key, prefix=prefix, debug=debug)
